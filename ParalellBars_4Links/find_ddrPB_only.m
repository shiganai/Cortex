function ddrPB = find_ddrPB_only(FrPB,ddthRib,ddthHand,ddthWaist,ddthShoulder,dthRib,dthHand,dthWaist,dthShoulder,g,mArm,mLBody,mLeg,mPB,mUBody,rArm,rArmMCD,rLBody,rLBodyMCD,rLegMCD,rUBody,rUBodyMCD,thHand,thShoulder,thWaist,thRib)
%FIND_DDRPB_ONLY
