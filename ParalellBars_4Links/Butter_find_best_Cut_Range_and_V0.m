...
V0_Ratio_List = (-1.5:0.05:1.5)';
Best_V0_Ratio_List_thHand = zeros(size(RMS_th_level));
Best_V0_Ratio_List_thShoulder = zeros(size(RMS_th_level));
Best_V0_Ratio_List_thWaist = zeros(size(RMS_th_level));
Best_V0_Ratio_List_hand_x = zeros(size(RMS_th_level));
Best_V0_Ratio_List_hand_y = zeros(size(RMS_th_level));
Best_V0_Ratio_List_rPB = zeros(size(RMS_th_level));
Best_V0_Ratio_List_thRib = zeros(size(RMS_th_level));

tic

ppm = ParforProgressbar(size(Cut_Range_Start_Index_tmp, 1),'showWorkerProgress',true);
parfor Cut_Range_Start_Index_tmp_Index = 1:size(Cut_Range_Start_Index_tmp, 1)
...
%         dthHand_spline = fnint(ddthHand_spline, 0);
    ...
    [RMS_thHand_tmp, Best_V0_Ratio_Index] = min(RMS_thHand_V0);
...
Best_V0_Ratio_thHand = Best_V0_Ratio_List_thHand(min_index)
...
Best_V0_Ratio_thRib = Best_V0_Ratio_List_thRib(min_index)
