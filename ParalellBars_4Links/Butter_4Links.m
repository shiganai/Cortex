...
Cut_Range = find(Data_Time == 3.555):find(Data_Time == 7.95);
Best_V0_Ratio_thHand = -0.2000;
Best_V0_Ratio_thShoulder = 0.8000;
Best_V0_Ratio_thWaist = 0.9500;
Best_V0_Ratio_hand_x = -0.5500;
Best_V0_Ratio_hand_y = 0.7500;
Best_V0_Ratio_rPB = 1.05000;
Best_V0_Ratio_thRib = 0.5000;
...
thDataArray = [TauHand_ActivatedRate, TauShoulder_ActivatedRate, TauWaist_ActivatedRate, TauRib_ActivatedRate];
MDataArray = [FrPB];
otherDataArray = rPB;
