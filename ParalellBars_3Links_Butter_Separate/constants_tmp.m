...
%         InertiaModel = InertiaModel_CompleteSticks;
    ...
    methods
        function obj = constants_tmp(mAll, r_Ankle_Toe, r_Knee_Ankle, r_Waist_Knee, r_Shoulder_Waist, r_Elbow_Shoulder, r_Wrist_Elbow, r_Finger_Wrist, r_Ear_Shoulder, r_Top_Ear)
