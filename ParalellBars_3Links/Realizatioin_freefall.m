...
rPB_filt_PB = fnval(rPB_raw_spline, Data_Time);
drPB_filt_PB = fnval(drPB_raw_spline, Data_Time);
ddrPB_filt_PB = fnval(ddrPB_raw_spline, Data_Time);
...
% q0 = [-(mAll + mPB) * g/(2*kPB), thHand_filt(1,1), thShoulder_filt(1,1), thWaist_filt(1,1), drPB_filt_Hand(1,1), dthHand_filt(1,1), dthShoulder_filt(1,1), dthWaist_filt(1,1)]';
...
Anime_Cortex_Realization = Anime_Cortex(time, ...
